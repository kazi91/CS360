...
public class Answer {
    ...
    /**
     * Returns the username of the answer's author.
     *
     * @return The username.
     */
    ...
    /**
     * Returns the timestamp of when the answer was submitted.
     *
    ...
    /**
     * Returns the acceptance status as a string.
     *
     * @return "Accepted" or "Pending acception".
     */
    ...
    /**
     * Gets the timestamp as a JavaFX property.
     *
    ...
    /**
     * Gets the acceptance status as a JavaFX property.
     *
     * @return A StringProperty containing the acceptance status.
     */
