...
public class ReviewerSelectQuestion {

    private final DatabaseHelper databaseHelper;
    private final User user;

    public ReviewerSelectQuestion(DatabaseHelper databaseHelper, User user) {
    ...
    public void show(Stage primaryStage) {
        ...
        Label header = new Label("Select a Question to Provide Feedback");
        ...
        selectButton.setOnAction(e -> {
            ...
            ReviewerFeedbackDialog.show(primaryStage, databaseHelper, user, selected.getId());
        });
