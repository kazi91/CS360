...
public class StaffReviewNote {
	 ...
	 public static void show(Stage owner, DatabaseHelper databaseHelper, User user, String questionId) {
	        ...
	        dialog.setTitle("Provide note on review");
	        dialog.setHeaderText("Provide note for Question ID: " + questionId);
	        ...
	        if (result.isPresent()) {
	            ...
	            try {
	                ...
	                int staffId = Integer.parseInt(user.getUserId());
	                databaseHelper.provideFeedback(qid, staffId, feedbackText);
