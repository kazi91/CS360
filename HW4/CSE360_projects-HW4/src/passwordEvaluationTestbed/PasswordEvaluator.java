...
//		String errMessage = "";
//		if (!foundUpperCase)
//			errMessage += "An upper case character is still required; ";
//		
//		if (!foundLowerCase)
//			errMessage += "An lower case character is still required; ";
//		
//		if (!foundNumericDigit)
//			errMessage += "Numeric digits are still expected; ";
//			
//		if (!foundSpecialChar)
//			errMessage += "A special character is still expected; ";
//			
//		if (!foundLongEnough)
//			errMessage += "The password is not long Enough; ";
//		
//		if (errMessage == "")
//			return "";
		...
		passwordIndexofError = currentCharNdx;
		System.out.println(errMessage + "conditions were not satisfied");
